...
$(function () {
    // 鼠标经过增加边框
            $(".seckill-itemcat").hover(function () {
...
//             $("#seckill").append(
//                 "<li class='seckill-itemcat'><div class='pic' ><img src='" + list["img"] + "' alt=''></div><div class='intro'><span>" + list["desc"] + "</span></div>"
...
//                 + "</div>"
//                 + "<a class='sui-btn btn-block btn-buy' href='seckill-itemcat.html' target='_blank'>立即抢购</a>"
//                 + "</li >"
//             );
