...
/*商品分类*/
$(function() {
	$('.all-sort-list2 > .itemcat').hover(function() {
		//父类分类列表容器的高度

		$(this).addClass('hover');
		$(this).children('.itemcat-list').css('display', 'block');
	}, function() {
		$(this).removeClass('hover');
		$(this).children('.itemcat-list').css('display', 'none');
	});

	$('.itemcat > .itemcat-list > .close').click(function() {
...
$(function() {
	...
	$(".close").click(function() {
		$("li.tab-itemcat").animate({
			"top": 0
		});
		$(".life-detail").removeClass("lifenow");

	});
	$("li.tab-itemcat").each(function(index) {
		var liNode = $(this);
