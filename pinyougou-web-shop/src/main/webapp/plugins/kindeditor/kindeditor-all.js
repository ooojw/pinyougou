...
_extend(KMenu, KWidget, {
	...
	addItem : function(item) {
		...
		var itemDiv = K('<div class="ke-menu-itemcat" unselectable="on"></div>'),
			leftDiv = K('<div class="ke-inline-block ke-menu-itemcat-left"></div>'),
			rightDiv = K('<div class="ke-inline-block ke-menu-itemcat-right"></div>'),
		...
		if (self.centerLineMode) {
			centerDiv = K('<div class="ke-inline-block ke-menu-itemcat-center"></div>');
			if (height) {
				centerDiv.css('height', height);
			}
		}
		itemDiv.mouseover(function(e) {
			K(this).addClass('ke-menu-itemcat-on');
			if (centerDiv) {
				centerDiv.addClass('ke-menu-itemcat-center-on');
			}
		})
		.mouseout(function(e) {
			K(this).removeClass('ke-menu-itemcat-on');
			if (centerDiv) {
				centerDiv.removeClass('ke-menu-itemcat-center-on');
			}
		})
		.click(function(e) {
	...
	remove : function() {
		...
		K('.ke-menu-itemcat', self.div[0]).unbind();
...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function createView(result) {
			...
			for (var i = 0, len = fileList.length; i < len; i++) {
				var data = fileList[i],
					div = K('<div class="ke-inline-block ke-itemcat"></div>');
				bodyDiv.append(div);
...
K.extend(KSWFUpload, {
	...
	removeFiles : function() {
		var self = this;
		K('.ke-itemcat', self.bodyDiv).each(function() {
			self.removeFile(K(this).attr('data-id'));
		});
	},
	appendFile : function(file) {
		var self = this;
		var itemDiv = K('<div class="ke-inline-block ke-itemcat" data-id="' + file.id + '"></div>');
