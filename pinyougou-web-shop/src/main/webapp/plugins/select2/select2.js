...
(function ($, undefined) {
     ...
     * value of 'text' which will be used to match choices. Alternatively, text can be a function(itemcat) that can extract
     * the text.
     */
    function local(options) {
        var data = options, // data elements
            dataText,
            tmp,
            text = function (item) { return ""+item.text; }; // function used to retrieve the text portion of a data itemcat that is matched against the search
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        highlightUnderEvent: function (event) {
            ...
            if (el.length > 0 && !el.is(".select2-highlighted")) {
                ...
                // if we are over an unselectable itemcat remove all highlights
                this.removeHighlight();
            }
        },
        ...
        prepareOpts: function () {
            ...
            if (opts.element.get(0).tagName.toLowerCase() === "select") {
                ...
                opts.initSelection = opts.initSelection || function (element, callback) {
                    var id = element.val();
                    //search in data by id, storing the actual matching itemcat
                    var match = null;
                    opts.query({
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        onSortEnd:function() {
            ...
            // make sure the search container is the last itemcat in the list
